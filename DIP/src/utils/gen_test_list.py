...
def generate_unique_source_paths(input_txt_files, output_txt_file):
    ...
    print(f"Start processing {len(input_txt_files)} input files...")
        ...
        with open(txt_file, 'r', encoding='utf-8') as f:
            ...
            for line in lines:
                ...
                if '/ori-embedding/' in line and '/BigVul/' in line and line.endswith('.json'):
                    ...
                    src_path = src_path[:-5] + '.c' # Remove .json (5 characters) and add .c.
                    ...
                    # If the format does not match, you can either ignore it or print a warning.
                    # print(f"Skip line with unexpected format: {line}")
                    pass

    print(f"Collection complete. Found {len(unique_paths)} unique source paths.")

    # Write the sorted paths for easier inspection.
