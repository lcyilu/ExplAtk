...
CODA_DB_DIR = _s.coda_db_dir
CODA_CODE_DB = _s.coda_code_db
CODA_SRC_PATHS = _s.coda_src_paths

TRAINING_SET_SRC_PATH = _s.training_set_src_path
DB_NAME = "reveal"
TRAINING_SET_LIST_PATH = _s.training_set_list_path(DB_NAME)

MODEL_NAME = "ivdetect"
CHECKPOINT_PATH = _s.ivdetect_checkpoint
DEVICE = _s.device
...
LOCAL_CODET5_PATH = _s.local_codet5_path

POP_SIZE = _s.pop_size
MAX_GEN = _s.max_gen
MOAA_MAX_GEN = _s.moaa_max_gen
