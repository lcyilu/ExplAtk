...
def joern_export(bin, outdir, repr):
    ...
    if repr == 'pdg':
        ...
        run_script_cmd = f"cpg.all.toJsonPretty |> \"{out}\"\r" #json
...
if __name__ == '__main__':
    ...
    # joern_path = '{JOERN_PATH}'
    # os.chdir(joern_path)
    # joern_export('{HOME_PATH}/VulDS/BigVul/all-cpg-bin/vul/1_CVE-2016-0842_Android_CWE-119_943323f1d9d3dd5c2634deb26cbe72343ca6b3db.bin',outdir='{HOME_PATH}/vul_explain/23_explain_eval_ISSTA/', repr='lineinfo_json')